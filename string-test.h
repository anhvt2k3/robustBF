...
const vector<char>lst_x = {'a','b','c','d','e'};
const vector<char>lst_z = {'f','g','h','i','k'};
...
std::string activateGenerator(std::vector<char> charSet, std::string filename, int maxLength = 7)
{
    // Output file name
